This file is a work in progress to help getting familiar with meshing and Metris. For an introduction to the data structures used, refer to [data structures](dataStructures.md), which also serves as a handy cheatsheet for the exercises below.

Directory exercises/ contains exercises to work through and solutions/ the corresponding descriptions of the algorithms/discussion.
