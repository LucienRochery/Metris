...
if(PkgConfig_FOUND)
    ...
    if(PC_NLOPT_FOUND)
      ...
      message(STATUS "NLOPT_INCLUDE_DIRS: ${PC_NLOPT_INCLUDE_DIRS}")
      message(STATUS "NLOPT_LIBRARIES: ${PC_NLOPT_LIBRARIES}")
      message(STATUS "NLOPT_LIBRARY_DIRS: ${PC_NLOPT_LIBRARY_DIRS}")

      # pkg-config succeeded, use its results directly
      if(PC_NLOPT_INCLUDE_DIRS)
        set(NLOPT_INCLUDE_DIRS ${PC_NLOPT_INCLUDE_DIRS})
      else()
        message("## PC failed to populate NLOPT_INCLUDE_DIRS!")
        set(NLopt_FOUND FALSE)
        return()
      endif()
      if(PC_NLOPT_LIBRARIES)
        set(NLOPT_LIBRARIES ${PC_NLOPT_LIBRARIES})
      else()
        message("## PC failed to populate NLOPT_LIBRARIES!")
        set(NLopt_FOUND FALSE)
        return()
      endif()
      if(PC_NLOPT_LIBRARY_DIRS)
        ...
        message("## PC failed to populate NLOPT_LIBRARY_DIRS!")
        set(NLopt_FOUND FALSE)
        return()
      endif()
