...
template int dsyevq<2,SANS::SurrealS<3,double>>(const SANS::SurrealS<3,double>* __restrict__ A,SANS::SurrealS<3,double>* __restrict__ Q,SANS::SurrealS<3,double>* __restrict__ w);
