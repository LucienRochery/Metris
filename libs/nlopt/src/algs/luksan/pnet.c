...
static void pnet_(int *nf, int *nb, double *xcur, int *
...
{
    double c_b7 = 0; // instead of a global
...
/* L2: */
	...
	luksan_pcbs04__(nf, &xcur[1], &ix[1], &xl[1], &xu[1], &eps9, &kbf);
	luksan_pyadc0__(nf, &n, &xcur[1], &ix[1], &xl[1], &xu[1], &inew);
    }
...
L11020:
    ...
    luksan_mxvcop__(nf, &xcur[1], &xo[1]);
L11040:
...
L12520:
    ...
    ld = 0;
    luksan_mxudir__(nf, &pp, &xs[1], &xo[1], &xcur[1], &ix[1], &kbf);
    objgrad(*nf, &xcur[1], &gf[1], objgrad_data);
    ++*(stop->nevals_p);
    ++stat_1->nfg;
    ld = kd;
...
/*     ------------------------------ */
    ...
    luksan_mxvcop__(nf, &xo[1], &xcur[1]);
...
/* Computing MIN */
    ...
    luksan_pytrcs__(nf, &xcur[1], &ix[1], &xo[1], &xl[1], &xu[1], &gf[1], &go[1],
...
L11060:
    ...
    luksan_mxudir__(nf, &r__, &s[1], &xo[1], &xcur[1], &ix[1], &kbf);
    luksan_pcbs04__(nf, &xcur[1], &ix[1], &xl[1], &xu[1], &eps9, &kbf);
    *f = objgrad(*nf, &xcur[1], &gf[1], objgrad_data);
    ++*(stop->nevals_p);
    ++stat_1->nfg;
...
L11064:
	...
	*f = fo;
    ...
    luksan_pytrcd__(nf, &xcur[1], &ix[1], &xo[1], &gf[1], &go[1], &r__, f, &fo, &
